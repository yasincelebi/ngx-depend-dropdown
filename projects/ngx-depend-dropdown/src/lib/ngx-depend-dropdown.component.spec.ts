...
describe('NgxDependDropdownComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ NgxDependDropdownComponent, NgxDependDropdownNodeComponent ],
  ...
  it('select event should be called', () => {
    ...
    const e = fixture.debugElement.nativeElement.querySelectorAll('.depend-dropdown-node-select');
    ...
    expect(component.select).toHaveBeenCalledWith({$event: event, data: expectedData[0]});
